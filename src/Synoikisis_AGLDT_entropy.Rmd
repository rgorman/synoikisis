...
doc.xml <- read_xml(file.path(input.dir, files.v[2]))
...
* **%>% filter(!(parent_POS) == "preposition")** limits the output to rows which are not objects of prepositions. 
